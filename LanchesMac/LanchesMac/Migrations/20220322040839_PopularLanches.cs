...
namespace LanchesMac.Migrations
{
    public partial class PopularLanches : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO Lanches(CategoriaId,DescricaoCurta,DescricaoDetalhada,EmEstoque,ImagemThumbnailUrl,ImagemUrl,IsLanchePreferido,Nome,Preco) VALUES(1,'Pão, presunto, mussarela e tomate','Delicioso pão francês quentinho na chapa com presunto e mussarela bem servidos com tomate preparado com carinho.',1,'https://imagensemoldes.com.br/wp-content/uploads/2020/07/Lanche-Misto-Quente-PNG.png','https://imagensemoldes.com.br/wp-content/uploads/2020/07/Lanche-Misto-Quente-PNG.png',0,'Misto Quente', 8.00)");
